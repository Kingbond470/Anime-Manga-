(function($){
	$.fn.lightBox=function(settings){
		settings=jQuery.extend({
			overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'js/images/lightbox-ico-loading.gif',imageBtnPrev:'js/images/lightbox-btn-prev.gif',imageBtnNext:'js/images/lightbox-btn-next.gif',imageBtnClose:'js/images/lightbox-btn-close.gif',imageBlank:'js/images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);
...
function _set_interface(){
	...
	$('#jquery-overlay').css({
		backgroundColor:settings.overlayBgColor,opacity:settings.overlayOpacity,width:arrPageSizes[0],height:arrPageSizes[1]}).fadeIn();
...
function _keyboard_action(objEvent){
	if(objEvent==null){
		...
		keycode=objEvent.keyCode;escapeKey=objEvent.DOM_VK_ESCAPE;
	}
...
function _preload_neighbor_images(){
	if((settings.imageArray.length-1)>settings.activeImage){objNext=new Image();
